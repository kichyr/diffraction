...
+ Для начала работы необходимо изобразить в окне границы исследуемого отверстия(замкнутые кривые без самопересечений) с помощью мыши и зажатой ЛКМ. Можно исследовать диффракцию для нескольких отверстий.
